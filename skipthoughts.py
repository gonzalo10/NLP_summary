...
#-----------------------------------------------------------------------------
path_to_models = '/Users/g10/Documents/Gonzalo/Code/text summary/tensorflow/'
path_to_tables = '/Users/g10/Documents/Gonzalo/Code/text summary/tensorflow/'
#-----------------------------------------------------------------------------#
...
def load_model():
    ...
    with open('%s.pkl'%path_to_umodel, 'rb') as f:
        uoptions = pkl.load(f, encoding='latin1')
    with open('%s.pkl'%path_to_bmodel, 'rb') as f:
        boptions = pkl.load(f, encoding='latin1')
